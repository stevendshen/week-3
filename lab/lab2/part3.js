...
var data = bikeArrayClean; // inspect the data
console.log(data);

var largeStationList = _.filter(data, function(x){if(x[3]>20){return(x);}}); // task 1
console.log(largeStationList);

var largeStationCount = _.countBy(data, function(x){return(x[3]>20);});
